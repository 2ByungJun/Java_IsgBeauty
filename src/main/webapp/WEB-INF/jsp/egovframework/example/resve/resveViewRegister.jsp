	...
	<form:form commandName="mberVO" id="detailForm" name="detailForm"
		...
		<div class="container">
			...
			<h2 style="text-align: center;">
				<b><span style="color:#000080;">'${param.selectedDate}'</span> 예약 등록</b>
			</h2>
			...
			<div style="width: 100%; display: inline-flex; padding-bottom: 2px">
				...
				<div style="width: 60%; text-align: left; display: grid">
					...
					<div style="display: inline-flex;">
						<select type="text" class="bjWidth form-control" id="mberSn" name="mberSn">
					...
					<!-- 예약일시 -->
					<div style="display: inline-flex;">
						<input type="date" class="bjWidth form-control" id="resveDt" name="resveDt" value="${param.selectedDate}" readonly>
					</div>
